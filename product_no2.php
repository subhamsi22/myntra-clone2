...
<head>
    ...
    <title> Buy Hyphen conditioner </title>
...
<!-- link to db 1 for image  -->
 ...
 $mysql = "SELECT * FROM data2 WHERE id=8 ";
 ...
 <div class="detials_for_product">
  <h1>Hyphen</h1>
  <p id="pp">Tinted Lip Balm with 1% Vit E & 2% Squalane to Brighten & Moisturize 10g - Hazel
</p>
...
<!-- php for find the price  -->
 ...
 $conn2 = mysqli_connect("localhost","root","","subham");
  ...
  $sql2 =  "SELECT * FROM data2 WHERE id=8 ";
  $result2 =mysqli_query($conn2,$sql2);
  $RES2 = mysqli_fetch_assoc($result2);
 
 ?>
<span id="newproduct2"> ₹ <?php echo $RES2['price']; ?> <span style="color:gray"> MRP  <span style=" text-decoration: line-through;">₹ 399</span>  (5% off)</span></span>
<div class="boxofpro">

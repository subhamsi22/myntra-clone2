...
<head>
    ...
    <title>Buy Soie
Pink & Blue Colourblocked Non-Wired Lightly Padded Training High Impact Sports Bra</title>
...
<!-- link to db 1 for image  -->
 ...
 $mysql = "SELECT * FROM data3 WHERE id=1 ";
 ...
 <div class="detials_for_product">
  ...
  <br>
  <p id="pp">Pink & Blue Colourblocked Non-Wired Lightly Padded Training High Impact Sports Bra
</p>
<span id="newproduct1">4.2 <i class="fa fa-star" aria-hidden="true"></i>  566 rating <hr></span>
<!-- php for find the price  -->
 ...
 $conn2 = mysqli_connect("localhost","root","","subham");
  ...
  $sql2 =  "SELECT * FROM data3 WHERE id = 1 ";
...
<div class="boxofpro">
  ...
  <p>Pink & Blue Colourblocked Non-Wired Lightly Padded Training High Impact Sports Bra</p>
  <p>Soie Pink & Blue Colourblocked Non-Wired Lightly Padded Training High Impact Sports Bra is designed for maximum comfort and support during workouts.</p>
  <p>It features a stylish colorblock design and is made from breathable fabric.</p>

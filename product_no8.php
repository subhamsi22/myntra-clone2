...
<head>
    ...
    <title> Buy NIVEA express hydration body lotion </title>
...
<!-- link to db 1 for image  -->
 ...
 $mysql = "SELECT * FROM data2 WHERE id=2 ";
 ...
 <div class="detials_for_product">
  <h1>NIVEA express hydration body lotion</h1>
  <p id="pp">NIVEA Express Hydration Body Lotion - 400 ml
</p>
...
<!-- php for find the price  -->
 ...
 $conn2 = mysqli_connect("localhost","root","","subham");
  ...
  $sql2 =  "SELECT * FROM data2 WHERE id=2 ";
...
<div class="boxofpro">
  ...
  <p> NIVEA Express Hydration Body Lotion - 400 ml</p>
  <p> Infused with 6 precious flower oils, this lotion gently moisturizes and nourishes skin, leaving it soft, smooth, and hydrated.</p>

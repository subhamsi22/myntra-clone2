...
<head>
    ...
    <title> Buy LOreal Paris Makeup Products Online at Best Price in India | Nykaa
...
<!-- link to db 1 for image  -->
 ...
 $mysql = "SELECT * FROM data2 WHERE id=3 ";
 ...
 <div class="detials_for_product">
  <h1>LOreal Paris Makeup Products</h1>
  <p id="pp">Paris Extraordinary Oil Nourishing Shampoo 
</p>
...
<!-- php for find the price  -->
 ...
 $conn2 = mysqli_connect("localhost","root","","subham");
  ...
  $sql2 =  "SELECT * FROM data2 WHERE id=3 ";
  $result2 =mysqli_query($conn2,$sql2);
  $RES2 = mysqli_fetch_assoc($result2);
 
 ?>
<span id="newproduct2"> ₹ <?php echo $RES2['price']; ?> <span style="color:gray"> MRP  <span style=" text-decoration: line-through;">₹ 1409</span>  (54% off)</span></span>
<div class="boxofpro">
  <h3>about this item</h3>
  <p> Paris Extraordinary Oil Nourishing Shampoo for Dull and Dry Hair - 1 L</p>
  <p> Infused with 6 precious flower oils, this shampoo gently cleanses and nourishes hair from root to tip, leaving it soft, shiny and manageable.</p>
  <p> Suitable for dry and dull hair types.</p>
<p>best shampoo</p>

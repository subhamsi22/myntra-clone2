...
<head>
    ...
    <title> Buy boAt Headphone </title>
...
<!-- link to db 1 for image  -->
 ...
 $mysql = "SELECT * FROM data2 WHERE id=6 ";
 ...
 <div class="detials_for_product">
  ...
  <p id="pp">boAt Rockerz 450 Bluetooth On-Ear Headphones with Mic - Black
</p>
...
<!-- php for find the price  -->
 ...
 $conn2 = mysqli_connect("localhost","root","","subham");
  ...
  $sql2 =  "SELECT * FROM data2 WHERE id=6 ";
  $result2 =mysqli_query($conn2,$sql2);
  $RES2 = mysqli_fetch_assoc($result2);
 
 ?>
<span id="newproduct2"> ₹ <?php echo $RES2['price']; ?> <span style="color:gray"> MRP  <span style=" text-decoration: line-through;">₹ 3300</span>  (55% off)</span></span>
<div class="boxofpro">
  <h3>about this item</h3>
  <p> boAt Rockerz 450 Bluetooth On-Ear Headphones with Mic - Black</p>
  <p>1. 100% Original Products</p>
  <p>2. Up to 15 Hours of Playback</p>
  <p>3. Bluetooth v5.0 with A2DP, AVRCP,
  HFP, HSP</p>
  <p>4. 40mm Drivers with Deep Bass</p>

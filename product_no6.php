...
<!-- link to db 1 for image  -->
 ...
 $mysql = "SELECT * FROM data2 WHERE id=4 ";
 ...
 <div class="detials_for_product">
  ...
  <p id="pp">Women Blue High-Rise Light Fade Stretchable Cotton Straight Fit Jeans
</p>
...
<!-- php for find the price  -->
 ...
 ?>
<span id="newproduct2"> ₹ <?php echo $RES2['price']; ?> <span style="color:gray"> MRP  <span style=" text-decoration: line-through;">₹ 2199</span>  (46% off)</span></span>
<div class="boxofpro">
  <h3>about this item</h3>
  <p> Women Blue High-Rise Light Fade Stretchable Cotton Straight Fit Jeans</p>

...
<head>
    ...
    <title> Buy Kurti |  Lastest Kurti in india </title>
...
<!-- link to db 1 for image  -->
 ...
 $mysql = "SELECT * FROM data3 WHERE id=6 ";
 ...
 <div class="detials_for_product">
  <h1>Sangria</h1>
  <br>
  <p id="pp">Printed V-Neck Sleeveless Peplum Top
</p>
...
<!-- php for find the price  -->
 ...
 $conn2 = mysqli_connect("localhost","root","","subham");
  ...
  $sql2 =  "SELECT * FROM data3 WHERE id = 6 ";
  $result2 =mysqli_query($conn2,$sql2);
  $RES2 = mysqli_fetch_assoc($result2);
 
 ?>
<span id="newproduct2"> ₹ <?php echo $RES2['number_price']; ?> <span style="color:gray"> MRP  <span style=" text-decoration: line-through;">₹ 700</span>  (35% off)</span></span>
<div class="boxofpro">

...
<head>
    ...
    <title> Buy The Indian Garage Co </title>
...
<!-- link to db 1 for image  -->
 ...
 $mysql = "SELECT * FROM data2 WHERE id=5 ";
 ...
 <div class="detials_for_product">
  <h1>The Indian Garage Co</h1>
  <p id="pp">The Indian Garage Co Men's Regular Fit Casual Shirt
</p>
...
<!-- php for find the price  -->
 ...
 $conn2 = mysqli_connect("localhost","root","","subham");
  ...
  $sql2 =  "SELECT * FROM data2 WHERE id=5 ";
  $result2 =mysqli_query($conn2,$sql2);
  $RES2 = mysqli_fetch_assoc($result2);
 
 ?>
<span id="newproduct2"> ₹ <?php echo $RES2['price']; ?> <span style="color:gray"> MRP  <span style=" text-decoration: line-through;">₹ 1599</span>  (74% off)</span></span>
<div class="boxofpro">
  <h3>about this item</h3>
  <p> The Indian Garage Co Men's Regular Fit Casual Shirt</p>
  <p>1. 100% Original Products</p>
  <p>2. Premium Quality Fabric for Comfort</p>  
  <p>3. Stylish Design for a Trendy Look</p>
  <p>4. Durable Stitching for Longevity</p>

...
<head>
    ...
    <title> Buy SWADESI STUFF  watch   </title>
...
<!-- link to db 1 for image  -->
 ...
 $mysql = "SELECT * FROM data3 WHERE id=5 ";
 ...
 <div class="detials_for_product">
  <h1>SWADESI STUFF</h1>
  <br>
  <p id="pp">Men Round Dial & Straps Analogue Watch ROTATE 005 YELLOW 18
</p>
...
<!-- php for find the price  -->
 ...
 $conn2 = mysqli_connect("localhost","root","","subham");
  ...
  $sql2 =  "SELECT * FROM data3 WHERE id = 5 ";
...
<div class="boxofpro">
  ...
  <p>Round Dial with Straps Analogue Watch</p>
  <p>Case Diameter: 45 mm</p>
  <p>Strap Width: 20 mm</p>
  <p>Strap Material: Silicone</p>

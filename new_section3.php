...
<head>
    ...
    <title> Buy CeraVe moisturizer  </title>
...
<!-- link to db 1 for image  -->
 ...
 $mysql = "SELECT * FROM data3 WHERE id=4 ";
 ...
 <div class="detials_for_product">
  <h1>CeraVe</h1>
  <br>
  <p id="pp">Moisturizing Cream</p>
<span id="newproduct1">4.6 <i class="fa fa-star" aria-hidden="true"></i>  1.8k rating <hr></span>
<!-- php for find the price  -->
 ...
 $conn2 = mysqli_connect("localhost","root","","subham");
  ...
  $sql2 =  "SELECT * FROM data3 WHERE id = 4 ";
  $result2 =mysqli_query($conn2,$sql2);
  $RES2 = mysqli_fetch_assoc($result2);
 
 ?>
<span id="newproduct2"> ₹ <?php echo $RES2['number_price']; ?> <span style="color:gray"> MRP  <span style=" text-decoration: line-through;">₹ 3495</span>  (77% off)</span></span>
<div class="boxofpro">
  <h3>about this item</h3>
  <p>Moisturizing Cream</p>
  <p>Net Quantity: 100 ml</p>
  <p>Skin Type: Dry Skin</p>
  <p>Product Form: Cream</p>
  <p>Flavour: Unscented</p>
  <p>Ingredient Type: Natural</p>
